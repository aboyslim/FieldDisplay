<%@ Page Title="" Language="C#" MasterPageFile="~/FieldServicesDisplayMaster.Master" AutoEventWireup="true" CodeBehind="Austin.aspx.cs" Inherits="FieldServicesDisplay.Austin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true"></asp:ScriptManager>
    <script type="text/javascript">
        ...
        var zoom = 9;
        var center = new google.maps.LatLng(30.300589, -97.736672); //Static center of where all markers can be shown
