<%@ Page Title="" Language="C#" MasterPageFile="~/FieldServicesDisplayMaster.Master" AutoEventWireup="true" CodeBehind="Dallas.aspx.cs" Inherits="FieldServicesDisplay.Dallas1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var zoom = 9;
        var center = new google.maps.LatLng(32.780340, -96.797756); //Static center of where all markers can be shown
    ...
    <h1 style="text-align: center; margin-bottom: 0; font-size: 36px;">DALLAS</h1>
