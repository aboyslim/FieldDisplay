<%@ Page Title="" Language="C#" MasterPageFile="~/FieldServicesDisplayMaster.Master" AutoEventWireup="true" CodeBehind="Dubai.aspx.cs" Inherits="FieldServicesDisplay.Dubai" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var zoom = 10;
        var center = new google.maps.LatLng(25.212830, 55.321814); //Static center of where all markers can be shown
    ...
    <h1 style="text-align: center; margin-bottom: 0; font-size: 36px;">DUBAI</h1>
