<%@ Page Title="" Language="C#" MasterPageFile="~/FieldServicesDisplayMaster.Master" AutoEventWireup="true" CodeBehind="Midland.aspx.cs" Inherits="FieldServicesDisplay.Midland" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true"></asp:ScriptManager>
    <script type="text/javascript">
        ...
        var zoom = 8;
        var center = new google.maps.LatLng(32.019197, -102.081084); //Static center of where all markers can be shown
    ...
    <h1 style="text-align: center; margin-bottom: 0; font-size: 36px;">Midland</h1>
