<%@ Page Title="" Language="C#" MasterPageFile="~/FieldServicesDisplayMaster.Master" AutoEventWireup="true" CodeBehind="NewJersey.aspx.cs" Inherits="FieldServicesDisplay.NewJersey" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var zoom = 8;
        var center = new google.maps.LatLng(40.125737, -76.311882); //Static center of where all markers can be shown
    ...
    <h1 style="text-align: center; margin-bottom: 0; font-size: 36px;">New Jersey</h1>
