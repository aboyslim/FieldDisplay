<%@ Page Title="" Language="C#" MasterPageFile="~/FieldServicesDisplayMaster.Master" AutoEventWireup="true" CodeBehind="Woodlands.aspx.cs" Inherits="FieldServicesDisplay.Woodlands" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var zoom = 10;
        var center = new google.maps.LatLng(30.173361, -95.502567); //Static center of where all markers can be shown
    ...
    <h1 style="text-align: center; margin-bottom: 0; font-size: 36px;">WOODLANDS</h1>
